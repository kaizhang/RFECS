...
for j=1:ncv
   ...
   %Tj = treefit(X(trainrows,:),id(trainrows),'categorical',Tree.catcols,'categorical_group',Tree.catgrp, args{:});
Tj = treefit_new(X(trainrows,:),id(trainrows),...
                 'categorical',Tree.catcols,'categorical_group',Tree.catgrp,args{:});
