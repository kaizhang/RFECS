...
%   string matrix, or cell array of strings) or a cell array of grouping
%   variables.  If GROUP is a cell array, all of the grouping variables that
%   it contains must have the same number of rows.  SEP is a separator for the
...
%   $Revision: 1.4.2.7 $  $Date: 2008/10/08 18:23:42 $
